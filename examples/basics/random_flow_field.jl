...
# ╔═╡ 7c4babbb-dff5-4f82-995f-969027baba69
HTML("""
<!-- the wrapper span -->
<div>
...
begin
	np,nq=size(F.u0)
	x=np*(0.4 .+ 0.2*rand(10)) #rand(x) x will be the nb of particles seeded
	y=nq*(0.4 .+ 0.2*rand(10))
	I=Individuals(F,x,y)
end
...
# ╔═╡ 13f9a86b-6e2f-499b-a052-206d4f1ee299
begin
	I.🔴
end
