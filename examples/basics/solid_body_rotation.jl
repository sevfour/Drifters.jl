...
# ╔═╡ 297eb221-f2ee-4a87-bf1a-426db53d19be
HTML("""
<!-- the wrapper span -->
<div>
...
# ╔═╡ fa58c8df-9e59-4cd5-8a69-d7921c49186c


# ╔═╡ 54a709f3-5c53-4f99-9099-61bb99796c11
begin
	joinpath(tempdir(),"solid_body_rotation.mp4")
end

# ╔═╡ e3cf52df-7cef-4d60-bfa6-e2d25b1c31a6
begin
		p=Int(ceil(nt/50))
		tt=1:p:nt
		tt=tt.+(nt-maximum(tt))
